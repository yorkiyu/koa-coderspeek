...
define("/src/js/common/constants", [ "jquery" ], function(require, exports, module) {
    var $ = require("jquery");
    module.exports = {
        //base
        goTopTips: '<div class="gotop-tips"><div class="container text-center"><i class="glyphicon glyphicon-lamp"></i>&nbsp;按下<strong>Ctrl+Space</strong>回到顶部</div><div class="cancel"><i class="glyphicon glyphicon-remove"></i></div></div>',
...
define("/src/js/common/editor-debug", [ "jquery-debug" ], function(require, exports, module) {
    ...
    Editor.prototype.createEditor = function(callback) {
        ...
        require.async([ "simplemde-debug", "uploadi-debug", "simplemde-css-debug", "uploadi-css-debug" ], function(SimpleMDE, Uploadi) {

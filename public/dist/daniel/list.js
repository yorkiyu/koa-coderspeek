define("/dist/daniel/list.min-debug", [ "jquery-debug" ], function(require, exports, module) {
    var $ = require("jquery-debug");
    var bootstrap = require("/lib/bootstrap/3.3.6/js/bootstrap-debug.js");
    var lazyload = require("/src/js/common/lazyload-debug.js");
    var constants = require("/src/js/common/constants-debug.js");
    var baidu_t = require("/lib/baidu/1.0.5/baiduTemplate-debug.js");
...
define("/dist/daniel/list.min", [ "jquery" ], function(require, exports, module) {
    var $ = require("jquery");
...
*/
define("/lib/baidu/1.0.5/baiduTemplate-debug", [], function(require, exports, module) {
    (function() {
...
define("/lib/bootstrap/3.3.6/js/bootstrap-debug", [ "jquery-debug" ], function(require, exports, module) {
...
define("/lib/bootstrap/3.3.6/js/bootstrap", [ "jquery" ], function(require, exports, module) {
...
define("/src/js/common/constants-debug", [], function(require, exports, module) {
    module.exports = {
...
define("/src/js/common/editor-debug", [ "jquery-debug" ], function(require, exports, module) {
    var $ = require("jquery-debug");
    var editor = null, options;
    ...
    function createEditor() {
        ...
        require.async([ "simplemde-debug", "simplemde-css-debug", "uploadi-debug", "uploadi-css-debug" ], function(SimpleMDE, Uploadi) {
            editor = new SimpleMDE({
                element: document.getElementById(options.id),
                uploadi: Uploadi,
                upload_url: options.upload_url ? options.upload_url : "/upload/image",
                loading_src: options.loading_src ? options.loading_src : "/images/i_load.gif",
                status: false,
                spellChecker: false,
                insertTexts: {
                    image: Uploadi ? [ "![](", ")" ] : [ "![](", ")" ]
    ...
    function value(val) {
        return editor.value(val);
    }
    function getHtml() {
        return editor.options.previewRender(editor.value());
    }
});

define("/src/js/common/editor", [ "jquery" ], function(require, exports, module) {
    var $ = require("jquery");
    var editor = null, options;
    module.exports = function(opt) {
        options = opt;
    ...
    function createEditor() {
        ...
        require.async([ "simplemde", "simplemde-css", "uploadi", "uploadi-css" ], function(SimpleMDE, Uploadi) {
            editor = new SimpleMDE({
                element: document.getElementById(options.id),
                uploadi: Uploadi,
                upload_url: options.upload_url ? options.upload_url : "/upload/image",
...
define("/src/js/common/lazyload-debug", [ "jquery-debug" ], function(require, exports, module) {
    var $ = require("jquery-debug");
    //add event
    $(document).bind("loadimg", loadImg);
    var img_lists = [], loading = false;
    function loadImg() {
        if (img_lists.length <= 0 || loading) {
            return;
        }
        loading = true;
        var i = 0, scrollTop = $(window).scrollTop();
    ...
    function fixImgSize(obj, imgw, imgh, img_box) {
        var boxh = img_box.height(), boxw = img_box.width(), posX = img_box.attr("data-x"), posY = img_box.attr("data-y");
...
define("/src/js/common/lazyload", [ "jquery" ], function(require, exports, module) {
    var $ = require("jquery");
    //add event
    $(document).bind("loadimg", loadImg);
    var img_lists = [], loading = false;
